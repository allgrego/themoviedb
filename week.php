...
$url = $baseURI.'/trending/movie/week';

// Page handler
if(empty($_GET['page'])||$_GET['page']<1){
	header("Location: "."./week.php?page=1");
}else{
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<nav>
							<ul>
								<li><a href="./today.php" class="icon solid fa-info-circle">See trending movies of today</a></li>
					...
					<?php
						...
						?>
							<article class="thumb">
								...
								<div id="rating">
								<?php
									echo '<span><strong>Rating: '.($vote_average/2).' </strong></span>';
									for($i=0;$i<5;$i++){
